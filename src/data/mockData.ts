...
export const INSTITUTION_INFO = {
  ...
  phone: '01933-293294',
  helpline: '01933-293294',
  email: 'pcpulwama@gmail.com',
  altEmail: 'pcpulwama@gmail.com',
...
export const FACULTY_LIST: FacultyMember[] = [
  ...
  {
    id: 'f-2',
    name: 'Dr. Ajaz Ahmad Ganie',
    designation: 'Scientist Animal Science',
    qualification: 'Ph.D. in Animal Science',
  ...
  {
    id: 'f-3',
    name: 'Dr. Rayees Ahmad Wani',
    designation: 'Scientist Fruit Science',
    qualification: 'Ph.D. in Horticulture (Fruit Science)',
  ...
  {
    id: 'f-4',
    name: 'Dr. Gowhar Nabi Parrey',
    designation: 'Scientist Agro-Forestry',
    qualification: 'Ph.D. in Agro-Forestry',
  ...
  {
    id: 'f-5',
    name: 'Dr. Syed Shujat Hussain',
    designation: 'Scientist Soil Science',
    qualification: 'Ph.D. in Soil Science & Agricultural Chemistry',
  ...
  {
    id: 'f-6',
    name: 'Dr. Towseef Ahmad Wani',
    designation: 'Scientist FST/PHT',
    qualification: 'Ph.D. in Food Science & Technology',
  ...
  {
    id: 'f-7',
    name: 'Dr. Mohammad Saleem Dar',
    designation: 'SMS Plant Protection',
    qualification: 'Ph.D. in Plant Protection / Entomology',
  ...
  {
    id: 'f-8',
    name: 'Mr. Jahangir Ahmad Magray',
    designation: 'Computer Programmer',
    qualification: 'M.Tech / MCA in Computer Science',
  ...
  {
    id: 'f-9',
    name: 'Mr. Shahnawaz Nazki',
    designation: 'Junior Assistant Technical',
    qualification: 'B.Sc. Agriculture / IT',
...
export const DEMO_STUDENTS: StudentProfile[] = [
  {
    id: 'ETC/2025/BHT-042',
    name: 'Jahangir Ahmad Magray',
    guardianName: 'Mohammad Yousuf Magray',
    email: 'jahangirmagray@gmail.com',
    phone: '7006626378',
    emergencyContact: '9906123456',
    rollNumber: 'ETC/2025/BHT-042',
    registrationNumber: 'SKUAST-K-2025-BHT-42',
    courseId: 'bht-101',
    ...
    gender: 'Male',
    address: 'Namblabal, Pampore, Pulwama, Jammu & Kashmir - 192121',
  ...
  },
  {
    id: 'ETC/2025/BHT-015',
    name: 'Tabasum Ara',
    guardianName: 'Ghulam Hassan Bhat',
    email: 'tabasumara@gmail.com',
    phone: '9906987654',
    emergencyContact: '9419112233',
    rollNumber: 'ETC/2025/BHT-015',
    registrationNumber: 'SKUAST-K-2025-BHT-15',
    courseId: 'bht-101',
    courseTitle: 'One Year Basic Horticulture Training Course (BHT)',
    designation: 'Trainee (BHT)',
    division: 'Extension Training Centre (ETC) Malangpora Pulwama',
    ...
    gender: 'Female',
    address: 'Rajbagh, Sector-2, Srinagar, Jammu & Kashmir - 190008',
  ...
  {
    id: 'ETC/2025/BAT-018',
    name: 'Faisal Bashir Dar',
    guardianName: 'Bashir Ahmad Dar',
    email: 'faisalbashir@gmail.com',
    phone: '9797123987',
    emergencyContact: '7006887766',
    rollNumber: 'ETC/2025/BAT-018',
    registrationNumber: 'SKUAST-K-2025-BAT-18',
    courseId: 'bat-102',
    courseTitle: 'One Year Basic Agriculture Training Course (BAT)',
    designation: 'Trainee (BAT)',
    division: 'Extension Training Centre (ETC) Malangpora Pulwama',
    bloodGroup: 'B +ve',
    dateOfBirth: '2004-11-15',
    gender: 'Male',
    address: 'Khanabal, Anantnag, Jammu & Kashmir - 192101',
  ...
  },
  {
    id: 'ETC/2025/BHT-009',
    name: 'Mehak Jan',
    guardianName: 'Ab Rehman Mir',
    email: 'mehakjan@gmail.com',
    phone: '9419124455',
    emergencyContact: '9906778899',
    rollNumber: 'ETC/2025/BHT-009',
    registrationNumber: 'SKUAST-K-2025-BHT-09',
    courseId: 'bht-101',
    courseTitle: 'One Year Basic Horticulture Training Course (BHT)',
    designation: 'Trainee (BHT)',
    division: 'Extension Training Centre (ETC) Malangpora Pulwama',
    ...
    gender: 'Female',
    address: 'Beerwah, Budgam, Jammu & Kashmir - 191111',
  ...
  },
  {
    id: 'ETC/2025/BHT-022',
    name: 'Aaqib Gulzar',
    guardianName: 'Gulzar Ahmad Shah',
    email: 'aaqibshah@gmail.com',
    phone: '9149998877',
    emergencyContact: '9797554433',
    rollNumber: 'ETC/2025/BHT-022',
    registrationNumber: 'SKUAST-K-2025-BHT-22',
    courseId: 'bht-101',
    courseTitle: 'One Year Basic Horticulture Training Course (BHT)',
    designation: 'Trainee (BHT)',
    division: 'Extension Training Centre (ETC) Malangpora Pulwama',
    ...
    gender: 'Male',
    address: 'Malangpora Village, Pulwama, Jammu & Kashmir - 192301',
